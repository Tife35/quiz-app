export default [
  ...
  },
  {
    ...
    answers: [
      ...
      "A Javascript library for bulding dynamic user interfaces.",
      "A specific HTML version that was explicity created for React.",
      "A tool for making HTTP requests in a React apllication.",
    ],
  },
  {
    id: "q4",
